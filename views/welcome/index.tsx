...
export default function Welcome() {
  ...
  return (
    <Box className="flex-1 bg-atosBlue px-6 py-12 justify-between">
      {/* Top Section */}
      ...
      <Box className="flex-1 items-center justify-center relative">
        ...
        {/* Central Pin */}
        <Box className="bg-white/10 p-5 rounded-full items-center justify-center z-10" style={{ shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 8 }}>
      ...
      <VStack space="xl" className="mb-4">
        ...
        <VStack space="md" className="mt-4">
            ...
            <Button 
                size="xl" 
                variant="solid" 
                className="bg-atosDark rounded-3xl"
                onPress={() => navigation.navigate('Login')}
            >
                <ButtonText className="text-white font-bold text-lg">Entrar</ButtonText>
            </Button>
        </VStack>
